...
namespace Training119
{
    public class VideoWork
    {
        ...
        /// 初始化显示图像  
        ///   
        /// <PARAM&NBSP;NAME="HANDLE">控件的句柄  
        /// <PARAM&NBSP;NAME="LEFT">开始显示的左边距  
        /// <PARAM&NBSP;NAME="TOP">开始显示的上边距  
        /// <PARAM&NBSP;NAME="WIDTH">要显示的宽度  
        /// <PARAM&NBSP;NAME="HEIGHT">要显示的长度  
        ...
        /// 抓图  
        ///   
        /// <PARAM&NBSP;NAME="PATH">要保存bmp文件的路径  
